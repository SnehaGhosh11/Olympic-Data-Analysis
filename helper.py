...
def most_successful(df, sport):
    ...
    # Correcting the issue by using the correct column names
    athlete_medal_count = temp_df['Name'].value_counts().reset_index()
    athlete_medal_count.columns = ['Name', 'Medals']

    # Merging with original dataframe to get additional info
    merged_df = athlete_medal_count.merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport', 'region']].drop_duplicates('Name')
...
def most_successful_countrywise(df, country):
    ...
    merged_df = athlete_medal_count.merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport']].drop_duplicates('Name')
